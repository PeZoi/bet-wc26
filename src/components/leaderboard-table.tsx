      ...
      <table className="w-full text-left border-collapse">
        <thead>
          <tr className="border-b border-white/5 text-xs font-bold text-muted-foreground uppercase tracking-wider bg-white/[0.01]">
            ...
            <th className="py-4 px-6 text-center">Đúng Tỉ Số (+3đ)</th>
            <th className="py-4 px-6 text-center">Đúng Kết Quả (+1đ)</th>
                  ...
                  <div className="flex items-center gap-3">
                    <img
                      ...
                      className={`h-9 w-9 rounded-full object-cover border ${
                        isCurrentUser ? 'border-primary' : 'border-white/5'
                      }`}
                      onError={(e) => {
                    ...
                    <div className="flex flex-col">
                      <span className={`text-sm ${isCurrentUser ? 'text-primary font-bold' : 'text-white'}`}>
